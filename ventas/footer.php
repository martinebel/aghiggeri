  ...
  var uid="<?php if(isset($_SESSION['uid'])){ echo $_SESSION['uid'];} else {echo 'nada';}?>";
...
location.reload();
   ...
   function reloadTemp(id)
  {
     $.ajax({
        type: "POST",
        url: "cartClass.php?action=reloadCart&clave="+id+"&uid=nada",
        processData: false, 
        contentType: "application/json"
    })
    .done(function(datae, textStatus, jqXHR){
window.location.href="home.php";
    ...
    .fail(function(jqXHR, textStatus, errorThrown){     
     ...
     function continuarLuego(id)
  {
     $.ajax({
        type: "POST",
        url: "cartClass.php?action=continuarLuego&clave="+id+"&uid=nada",
        processData: false, 
        contentType: "application/json"
    })
    .done(function(datae, textStatus, jqXHR){
